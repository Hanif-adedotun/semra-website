...
export default function Events(){
     return (
       <>
         ...
         <section className="w-screen sm:overflow-hidden h-max sm:h-screen px-[7.5%] grid grid cols-1 sm:grid-cols-2 gap-12">
           <div className="hidden sm:block ">
             <Card className="border-0 shadow-none flex flex-col gap-2">
               ...
               <p className="font-light">
                 {events[0].description.slice(0, 300)}
               </p>
           ...
           <div className="sm:overflow-auto flex flex-col gap-12">
             {events.map((event) => (
               <Card className="flex flex-col sm:flex-row gap-4 border-0 shadow-none">
                 <Image
                   src={event.image}
                   alt={event.title}
                   width={200}
